...
class InstanceAggregatedListCallbackSpec extends Specification {
  ...
  def "should report is not healthy if no votes of any kind"() {
    setup:
    ...
    then:
      !InstanceAggregatedListCallback.calculateIsHealthy(googleInstance)
  }

  def "should report healthy if one up vote"() {
    setup:
      def googleInstance = new GoogleInstance()
  ...
  def "should report healthy if one up vote and multiple unknown votes"() {
    setup:
      def googleInstance = new GoogleInstance()
  ...
  def "should report unhealthy if just unknown votes"() {
    setup:
      def googleInstance = new GoogleInstance()
  ...
  def "should report unhealthy if any non-up or non-unknown votes"() {
    setup:
      def googleInstance = new GoogleInstance()
