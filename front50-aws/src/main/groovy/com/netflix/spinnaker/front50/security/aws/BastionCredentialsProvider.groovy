...
/**
 * A credentials provider that retrieves session credentials from an instance via a bastion host.
 * Entirely Netflix-internal material here.
 *
 * @author Dan Woods
 */
class BastionCredentialsProvider implements AWSCredentialsProvider {
  ...
  BastionCredentialsProvider(String user, String host, Integer port, String proxyCluster, String proxyRegion, String iamRole) {
    ...
    engine = new SshDslEngine(new SshOptions(defaultKeyFile: new File(sshKey)))
  }
