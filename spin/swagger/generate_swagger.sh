...
java -jar openapi-generator-cli.jar generate -i ../gate/swagger/swagger.json --git-user-id spinnaker --git-repo-id spinnaker/spin/gateapi -g go -o gateapi --skip-validate-spec --package-name gateapi
...
echo "Fixing bad generation objects"
