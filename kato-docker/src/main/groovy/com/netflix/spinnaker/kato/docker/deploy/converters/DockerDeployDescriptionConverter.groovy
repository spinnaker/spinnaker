...
class DockerDeployDescriptionConverter extends AbstractAtomicOperationsCredentialsSupport {
  @Override
  ...
  @Override
  DeployDescription convertDescription(Map input) {
    input.credentials = getCredentialsObject(input.credentials as String)
    new DockerDeployDescription(input)
  }
}
