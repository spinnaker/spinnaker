...
@Component
@CompileStatic
class DeleteProjectStage extends LinearStage {
  public static final String PIPELINE_CONFIG_TYPE = "deleteProject"
  ...
  public List<Step> buildSteps(Stage stage) {
    [buildStep(stage, "deleteProject", DeleteProjectTask)]
  }
