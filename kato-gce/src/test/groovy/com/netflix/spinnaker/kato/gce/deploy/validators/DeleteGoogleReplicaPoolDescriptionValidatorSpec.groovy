...
class DeleteGoogleReplicaPoolDescriptionValidatorSpec extends Specification {
  ...
  @Shared
  DeleteGoogleReplicaPoolDescriptionValidator validator

  void setupSpec() {
    validator = new DeleteGoogleReplicaPoolDescriptionValidator()
  ...
  void "null input fails validation"() {
    setup:
      def description = new DeleteGoogleReplicaPoolDescription()
      def errors = Mock(Errors)
