...
class ResetGoogleInstancesDescriptionValidatorSpec extends Specification {
  private static final ACCOUNT_NAME = "auto"
  private static final ZONE = "us-central1-b"
  private static final INSTANCE_IDS = ["my-app7-dev-v000-instance1", "my-app7-dev-v000-instance2"]

  @Shared
  ResetGoogleInstancesDescriptionValidator validator

  void setupSpec() {
    validator = new ResetGoogleInstancesDescriptionValidator()
  ...
  void "invalid instanceIds fail validation"() {
    setup:
      def description = new ResetGoogleInstancesDescription(instanceIds: [""])
      def errors = Mock(Errors)
  ...
  void "null input fails validation"() {
    setup:
      def description = new ResetGoogleInstancesDescription()
      def errors = Mock(Errors)
