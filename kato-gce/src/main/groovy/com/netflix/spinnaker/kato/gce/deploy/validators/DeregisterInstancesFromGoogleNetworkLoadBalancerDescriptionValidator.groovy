...
@Component("deregisterInstancesFromGoogleNetworkLoadBalancerDescriptionValidator")
class DeregisterInstancesFromGoogleNetworkLoadBalancerDescriptionValidator
  extends DescriptionValidator<DeregisterInstancesFromGoogleNetworkLoadBalancerDescription> {
  @Autowired
