...
class RecreateGoogleReplicaPoolInstancesAtomicOperation implements AtomicOperation<Void> {
  ...
  /**
   * curl -X POST -H "Content-Type: application/json" -d '[ { "recreateGoogleReplicaPoolInstancesDescription": { "replicaPoolName": "myapp-dev-v000", "instanceIds": ["myapp-dev-v000-abcd"], "zone": "us-central1-b", "credentials": "my-account-name" }} ]' localhost:8501/ops
   */
  @Override
