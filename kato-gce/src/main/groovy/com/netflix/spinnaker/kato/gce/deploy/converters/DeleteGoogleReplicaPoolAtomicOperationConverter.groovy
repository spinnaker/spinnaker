...
class DeleteGoogleReplicaPoolAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  ...
  AtomicOperation convertOperation(Map input) {
    new DeleteGoogleReplicaPoolAtomicOperation(convertDescription(input), new ReplicaPoolBuilder())
  }

  @Override
  DeleteGoogleReplicaPoolDescription convertDescription(Map input) {
    GoogleAtomicOperationConverterHelper.convertDescription(input, this, DeleteGoogleReplicaPoolDescription)
  }
}
