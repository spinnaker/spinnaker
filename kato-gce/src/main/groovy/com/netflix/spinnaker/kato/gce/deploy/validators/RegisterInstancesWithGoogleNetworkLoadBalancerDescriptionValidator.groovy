...
@Component("registerInstancesWithGoogleNetworkLoadBalancerDescriptionValidator")
class RegisterInstancesWithGoogleNetworkLoadBalancerDescriptionValidator
  extends DescriptionValidator<RegisterInstancesWithGoogleNetworkLoadBalancerDescription> {
  @Autowired
