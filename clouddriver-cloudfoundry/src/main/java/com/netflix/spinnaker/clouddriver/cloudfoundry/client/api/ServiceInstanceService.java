...
public interface ServiceInstanceService {
  ...
  Page<Service> findServiceBySpaceId(
      @Path("guid") String spaceGuid,
      @Query("page") Integer page,
      @Query("q") List<String> queryParams);

  @GET("/v2/service_plans")
  Page<ServicePlan> findServicePlans(
  ...
  Page<ServiceBinding> getBindingsForUserProvidedServiceInstance(
      @Path("guid") String userProvidedServiceInstanceGuid,
      @Query("page") Integer page,
      @Query("q") List<String> queryParams);
  ...
  Response shareServiceInstanceToSpaceIds(
  ...
  SharedTo getShareServiceInstanceSpaceIdsByServiceInstanceId(
      @Path("guid") String serviceInstanceGuid);

  @DELETE("/v3/service_instances/{guid}/relationships/shared_spaces/{space_guid}")
  Response unshareServiceInstanceFromSpaceId(
