...
public interface CloudMetricProvider<T extends CloudMetricDescriptor> {
   ...
   * @return a metric descriptor if one is found; should throw an exception if multiple metric
   *     descriptors are found for the supplied filters
   */
   ...
   * @param account the account
   * @param region the region
   * @param filters a collection of identifiers used to select a subset of all metrics in the
   *     account and region
   ...
   * @param account the account
   * @param region the region
   * @param metricName the name of the target metric
   * @param filters a collection of identifiers used to uniquely identify a metric
   ...
   */
  CloudMetricStatistics getStatistics(
      String account,
      String region,
      String metricName,
