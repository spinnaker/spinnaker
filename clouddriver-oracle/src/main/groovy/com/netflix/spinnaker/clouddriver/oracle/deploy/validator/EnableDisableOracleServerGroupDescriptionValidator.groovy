...
class EnableDisableOracleServerGroupDescriptionValidator extends DescriptionValidator<EnableDisableOracleServerGroupDescription> {

  @Override
  void validate(List priorDescriptions, EnableDisableOracleServerGroupDescription description, Errors errors) {
    def helper = new StandardOracleAttributeValidator("enableDisableServerGroupDescription", errors)
