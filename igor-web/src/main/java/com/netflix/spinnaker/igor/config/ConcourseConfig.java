...
public class ConcourseConfig {
  @Bean
  public Map<String, ConcourseService> concourseMasters(BuildServices buildServices, ConcourseCache concourseCache,
    ...
    Map<String, ConcourseService> concourseMasters = masters.stream()
