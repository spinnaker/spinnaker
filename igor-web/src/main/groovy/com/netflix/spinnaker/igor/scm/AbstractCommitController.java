...
public abstract class AbstractCommitController {
    ...
    public List<Map<String, Object>> getNotFoundCommitsResponse(String projectKey, String repositorySlug, String to, String from, String url) {
        Map<String, Object> eMap = new HashMap<>();
        eMap.put("displayId", "NOT_FOUND");
        eMap.put("id", "NOT_FOUND");
        eMap.put("authorDisplayName", "UNKNOWN");
        eMap.put("timestamp", Instant.now());
        eMap.put("message", String.format("could not find any commits from %s to %s in %s %s/%s", from, to, url, projectKey, repositorySlug));
