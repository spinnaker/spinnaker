...
class AmazonHealthIndicatorSpec extends Specification {
  ...
  NetflixAmazonCredentials credential(String name = 'foo') {
    new NetflixAmazonCredentials(name, name, name, '12345', 'key', [new AmazonCredentials.AWSRegion('us-east-1', ['us-east-1c', 'us-east-1d'])], null, null, false, null, false, null, false)
  }
}
