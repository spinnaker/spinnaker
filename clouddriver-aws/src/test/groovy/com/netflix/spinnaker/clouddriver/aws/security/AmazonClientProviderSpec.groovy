...
class AmazonClientProviderSpec extends Specification {
  ...
  @Shared NetflixAmazonCredentials credentialsWithEdda = new NetflixAmazonCredentials("test", "test", "test", "1", null, [new AmazonCredentials.AWSRegion('us-east-1', ['us-east-1e'])], null, credentialsProvider, 'foo', true, null, null, null, null)
  @Shared NetflixAmazonCredentials credentialsNoEdda = new NetflixAmazonCredentials("test", "test", "test", "1", null, [new AmazonCredentials.AWSRegion('us-east-1', ['us-east-1e'])], null, credentialsProvider, null, null, null, null, null, null)
