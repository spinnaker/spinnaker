...
const helpContents: {[key: string]: string} = {
  ...
  'gce.instance.labels.spinnaker-member-of': 'This label can be used to group instances when querying for metrics.',
  ...
  'gce.serverGroup.labels.spinnaker-member-of': 'This label can be used to group instances when querying for metrics.',
  ...
  'gce.serverGroup.canIpForward': 'Forwarding allows the instance to help route packets. See <a target="_blank" href="https://cloud.google.com/compute/docs/networking?hl=en_US#canipforward">here</a> for more information.',
...
module(GCE_HELP, [HELP_CONTENTS_REGISTRY])
