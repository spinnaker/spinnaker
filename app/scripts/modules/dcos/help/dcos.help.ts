...
const helpContents: { [key: string]: string } = {
  'dcos.loadBalancer.group': '<p>(Optional) The DC/OS group under which the application should live.</p><p> It can be a hierarchical path, delimited by backslashes.<p/><p>This will often be referred to as <b>Region</b> in Spinnaker.</p>',
  ...
  'dcos.loadBalancer.acceptedResourceRoles': '(Optional) Deploy the load balancer only on nodes with this role (default: slave_public).',
  'dcos.loadBalancer.bindHttpHttps': '<p>Reserve ports 80 and 443 for the load balancer.</p>Use this if you intend to use virtual hosts (default: true).',
  'dcos.loadBalancer.portRange.minPort': '(Required) The minimum port in the port range to be reserved. This value must be >= 10000 (default: 10000).',
  'dcos.loadBalancer.portRange.maxPort': '(Required) The maximum port in the port range to be reserved. This value must be <= 65535 (default: 10100).',
  ...
  'dcos.serverGroup.executor': 'Executor must be the string \'//cmd\', a string containing only single slashes (\'/\'), or blank.',
  'dcos.serverGroup.uris': 'Comma-separated list of valid URIs.',
  'dcos.serverGroup.constraints': 'Comma-separated list of valid constraints. Valid constraint format is "field:operator[:value]".',
  'dcos.serverGroup.acceptedResourceRoles': 'Comma-separated list of resource roles. Marathon considers only resource offers with roles in this list for launching tasks of this app.',
...
module(DCOS_HELP, [HELP_CONTENTS_REGISTRY])
