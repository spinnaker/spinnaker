...
module.exports = {
  ...
  output: {
    ...
    filename: '[name].js',
    library: '@spinnaker/cloudfoundry',
    libraryTarget: 'umd',
    umdNamedDefine: true,
  },
  devtool: 'source-map',
  ...
  resolve: {
    ...
    alias: {
      '@spinnaker/cloudfoundry': path.join(__dirname, 'src'),
      ...
      cloudfoundry: path.join(__dirname, 'src'),
    },
  },
  module: {
    rules: [
      ...
      },
      {
        ...
        exclude: exclusionPattern,
        use: [
          { loader: 'ngtemplate-loader?relativeTo=' + path.resolve(__dirname) + '&prefix=cloudfoundry' },
          { loader: 'html-loader' },
        ],
      },
      {
