...
class LoadBalancerSelectorController implements IController {
  ...
  constructor(
    private awsServerGroupConfigurationService: AwsServerGroupConfigurationService,
...
module(LOAD_BALANCER_SELECTOR, [AWS_SERVER_GROUP_CONFIGURATION_SERVICE, INFRASTRUCTURE_CACHE_SERVICE]).component(
