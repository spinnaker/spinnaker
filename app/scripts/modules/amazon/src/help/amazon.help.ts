...
const helpContents: {[key: string]: string} = {
  ...
  'aws.targetGroup.targetType': 'Determines how targets are specified. Only set to ip if you need to attach individual ips. Cannot be edited after being saved; if you want to use a different target type, create a new target group, save the load balancer, move your targets, and then delete this target group.',
