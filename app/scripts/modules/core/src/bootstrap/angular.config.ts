...
bootstrapModule.config(['$httpProvider', ($httpProvider: IHttpProvider) => {
  'ngInject';
...
bootstrapModule.config(['$compileProvider', ($compileProvider: ICompileProvider) => {
  'ngInject';
...
bootstrapModule.config(['$locationProvider', ($locationProvider: ILocationProvider) => {
  'ngInject';
