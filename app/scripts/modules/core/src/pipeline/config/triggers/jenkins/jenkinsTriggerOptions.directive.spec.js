...
describe('Jenkins Trigger: JenkinsTriggerOptionsCtrl', function() {
  ...
  beforeEach(window.module(require('./jenkinsTriggerOptions.directive.js').name));
  ...
  beforeEach(
    window.inject(function($rootScope, _igorService_, $controller, _$q_) {
      $scope = $rootScope.$new();
