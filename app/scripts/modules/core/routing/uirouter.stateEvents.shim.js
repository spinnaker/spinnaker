 ...
 */ /** */
import { isFunction, isString, module } from 'angular';
...
export const UI_ROUTER_STATE_SHIM = 'ui.router.state.events';

module(UI_ROUTER_STATE_SHIM, ['ui.router.state'])
  .provider('$stateEvents', $StateEventsProvider)
  .run(['$stateEvents', function () {
  }]);
