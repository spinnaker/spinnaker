...
import { API, RETRY_SERVICE } from '@spinnaker/core';

module.exports = angular
  .module('spinnaker.kubernetes.image.reader', [RETRY_SERVICE])
  .factory('kubernetesImageReader', function($q, retryService) {
