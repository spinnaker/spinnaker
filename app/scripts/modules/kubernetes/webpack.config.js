...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      '@spinnaker/kubernetes': path.join(__dirname, 'src'),
      ...
      kubernetes: path.join(__dirname, 'src'),
    },
  },
  module: {
    rules: [
      ...
      },
      {
        ...
        exclude: exclusionPattern,
        use: [
          { loader: 'ngtemplate-loader?relativeTo=' + path.resolve(__dirname) + '&prefix=kubernetes' },
          { loader: 'html-loader' },
        ],
      },
      {
