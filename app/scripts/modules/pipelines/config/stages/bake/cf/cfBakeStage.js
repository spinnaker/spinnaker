...
module.exports = angular.module('spinnaker.pipelines.stage.cf.bakeStage', [
  ...
  .controller('cfBakeStageCtrl', function($scope, bakeryService, $q, _, authenticationService) {
    ...
    function initialize() {
      $q.all({
        regions: bakeryService.getRegions('cf'),
