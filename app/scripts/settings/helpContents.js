...
angular.module('deckApp.help')
  .constant('helpContents', {
    ...
    'pipeline.config.jenkins.propertyFile': '<p>Configures the path to the Jenkins artifact file used to pass in properties to later stages in the Spinnaker pipeline.</p>',
