...
public class ManifestService {
  ...
  final private ProviderLookupService providerLookupService;
  final private ClouddriverService clouddriverService;

  @Autowired
  public ManifestService(ClouddriverService clouddriverService, ProviderLookupService providerLookupService) {
  ...
  public Map getManifest(String account, String location, String name) {
    return (Map) HystrixFactory.newMapCommand(
        GROUP,
        ...
        () -> {
          try {
            ...
            if (re.getKind() == RetrofitError.Kind.HTTP && re.getResponse() != null && re.getResponse().getStatus() == 404) {
