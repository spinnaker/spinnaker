...
public class ClouddriverProfile extends SpringProfile {
  ...
  @Override
  public ProfileConfig generateFullConfig(String baseConfig, DeploymentConfiguration deploymentConfiguration, SpinnakerEndpoints endpoints) {
    ...
    return new ProfileConfig().setConfigContents(contents).setRequiredFiles(files);
  }
}
