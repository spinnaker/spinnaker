...
public class KubernetesV1SharedServiceSettings extends SharedDistributedServiceSettings {

    public KubernetesV1SharedServiceSettings(DeploymentConfiguration deploymentConfiguration) {
