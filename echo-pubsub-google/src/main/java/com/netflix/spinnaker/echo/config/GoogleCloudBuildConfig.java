...
public class GoogleCloudBuildConfig {
  ...
  void googleCloudBuildSubscribers() {
    ...
    googleCloudBuildProperties.getAccounts().forEach((GoogleCloudBuildProperties.Account account) -> {
      GooglePubsubProperties.GooglePubsubSubscription subscription = GooglePubsubProperties.GooglePubsubSubscription.builder()
        ...
        .build();
      log.info("Bootstrapping Google Cloud Build Pubsub Subscriber listening to subscription: {} in project: {}",
      ...
      PubsubEventCreator pubsubEventCreator = new PubsubEventCreator(messageArtifactTranslator);

      PubsubMessageHandler pubsubMessageHandler = pubsubMessageHandlerFactory
        .create(Arrays.asList(pubsubEventCreator, googleCloudBuildEventCreator));
