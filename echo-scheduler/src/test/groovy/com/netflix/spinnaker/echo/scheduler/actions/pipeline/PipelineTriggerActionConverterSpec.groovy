...
class PipelineTriggerActionConverterSpec extends Specification {
    ...
    void 'toParameters() should return an equivalent map of parameters'() {
        setup:
        Trigger trigger = new Trigger(true, '123-456', 'cron', null, null, null, null, '* 0/30 * * * ? *', null, null, null, null, null, null, null, null, null, null, null)
    ...
    void 'toScheduledAction() should return an equivalent valid ActionInstance'() {
        setup:
        Trigger trigger = new Trigger(true, '123-456', 'cron', null, null, null, null, null, '* 0/30 * * * ? *', null, null, null, null, null, null, null, null, null, null)
