...
public class ErrorConfiguration {
  ...
  public ErrorAttributes errorAttributes() {
    ...
    return new ErrorAttributes() {
      ...
      public Map<String, Object> getErrorAttributes(
        ...
        // By default, Spring echoes back the user's requested path. This opens up a potential XSS
        // vulnerability where a
        // user, for example, requests "GET /<script>alert('Hi')</script> HTTP/1.1".
        Map<String, Object> errorAttributes =
            defaultErrorAttributes.getErrorAttributes(webRequest, includeStackTrace);
  ...
  @Bean
  public GenericErrorController genericErrorController(ErrorAttributes errorAttributes) {
