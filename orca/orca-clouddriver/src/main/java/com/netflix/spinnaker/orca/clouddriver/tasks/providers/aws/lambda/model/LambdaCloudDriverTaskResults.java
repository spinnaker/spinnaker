...
public class LambdaCloudDriverTaskResults {
  LambdaVerificationStatusOutput status;
  LambdaCloudDriverErrorObject errors;
  LambdaCloudDriverResultObject results;
}
