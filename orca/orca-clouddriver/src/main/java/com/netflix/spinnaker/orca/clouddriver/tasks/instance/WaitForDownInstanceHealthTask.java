...
@Component
@Slf4j
public class WaitForDownInstanceHealthTask implements OverridableTimeoutRetryableTask {

  private final CloudDriverService cloudDriverService;

  @Autowired
  public WaitForDownInstanceHealthTask(CloudDriverService cloudDriverService) {
