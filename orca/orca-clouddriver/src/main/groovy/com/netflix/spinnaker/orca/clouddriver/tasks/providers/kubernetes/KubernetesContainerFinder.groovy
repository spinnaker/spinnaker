...
class KubernetesContainerFinder {
  ...
  static void populateFromStage(Map operation, StageExecution stage, ArtifactUtils artifactUtils) {
    ...
    containers.forEach { container ->
      ...
      if (container?.imageDescription?.fromArtifact) {
        def resolvedArtifact = artifactUtils.getBoundArtifactForId(stage, container.imageDescription.artifactId)
