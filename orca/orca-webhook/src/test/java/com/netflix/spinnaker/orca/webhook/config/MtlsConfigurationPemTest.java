...
@SpringBootTest(
    classes = {
      MtlsConfigurationPemTest.PemTestConfiguration.class,
...
public class MtlsConfigurationPemTest extends MtlsConfigurationTestBase {
  static class PemTestConfiguration {
    ...
    WebhookProperties webhookProperties() {
      ...
      identity.setIdentityKeyPem(clientIdentityKeyPemFile.getAbsolutePath());
      identity.setIdentityCertPem(clientIdentityCertPemFile.getAbsolutePath());
      props.setIdentity(identity);

      var trust = new WebhookProperties.TrustSettings();
      trust.setEnabled(true);
      trust.setTrustPem(caPemFile.getAbsolutePath());
  ...
  @Test
  @SneakyThrows
  public void mTLSConnectivityPemTest() {
    var context =
