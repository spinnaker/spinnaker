...
class CloudFoundryWaitForDeployServiceTaskTest extends Specification {
  @Subject task = new CloudFoundryWaitForDeployServiceTask(null)
  ...
  def "returns TERMINAL for non-existent Oort service status"() {
    given:
    task.oortService = Stub(OortService) {
