...
@Component
public class WaitForClusterShrinkTask extends AbstractWaitForClusterWideClouddriverTask {
  @Override
  protected TaskResult missingClusterResult(
      StageExecution stage, ClusterSelection clusterSelection) {
    return TaskResult.SUCCEEDED;
  }

  @Override
  protected TaskResult emptyClusterResult(
      StageExecution stage, ClusterSelection clusterSelection, Cluster cluster) {
    return TaskResult.SUCCEEDED;
  }
  ...
  public boolean isServerGroupOperationInProgress(
    ...
    return currentServerGroup.isPresent();
  }
}
