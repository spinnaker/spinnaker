...
public class NetflixAssumeRoleAmazonCredentials extends NetflixAmazonCredentials {
    ...
    public NetflixAssumeRoleAmazonCredentials(@JsonProperty("name") String name,
        ...
        this(name, environment, accountType, accountId, defaultKeyPair, regions, requiredGroupMembership, null, edda, eddaEnabled, discovery, discoveryEnabled, front50, front50Enabled, assumeRole, sessionName);
    }
