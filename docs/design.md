...
Halyard itself will be a daemon listening to requests on port 8064[1], the content
of those requests will be generated by a user-friendly interface (either a web
UI or CLI), which will be described in a separate document.
