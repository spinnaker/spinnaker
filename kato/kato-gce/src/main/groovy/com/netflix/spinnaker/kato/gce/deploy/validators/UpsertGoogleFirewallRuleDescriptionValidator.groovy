...
class UpsertGoogleFirewallRuleDescriptionValidator extends
  ...
  @Override
  void validate(List priorDescriptions, UpsertGoogleFirewallRuleDescription description, Errors errors) {
    def helper = new StandardGceAttributeValidator("upsertGoogleFirewallRuleDescription", errors)
