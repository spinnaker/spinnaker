...
class UpsertGoogleFirewallRuleAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  ...
  AtomicOperation convertOperation(Map input) {
    new UpsertGoogleFirewallRuleAtomicOperation(convertDescription(input))
  }

  @Override
  UpsertGoogleFirewallRuleDescription convertDescription(Map input) {
    GoogleAtomicOperationConverterHelper.convertDescription(input, this, UpsertGoogleFirewallRuleDescription)
  }
}
