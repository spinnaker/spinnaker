...
class DeleteGoogleFirewallRuleAtomicOperationUnitSpec extends Specification {
  ...
  void "should delete firewall rule"() {
    setup:
      ...
      @Subject def operation = new DeleteGoogleFirewallRuleAtomicOperation(description)
