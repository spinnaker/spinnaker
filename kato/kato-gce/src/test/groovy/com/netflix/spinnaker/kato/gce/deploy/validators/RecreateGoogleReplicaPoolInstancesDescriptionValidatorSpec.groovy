...
class RecreateGoogleReplicaPoolInstancesDescriptionValidatorSpec extends Specification {
  ...
  @Shared
  RecreateGoogleReplicaPoolInstancesDescriptionValidator validator

  void setupSpec() {
    validator = new RecreateGoogleReplicaPoolInstancesDescriptionValidator()
  ...
  void "null input fails validation"() {
    setup:
      def description = new RecreateGoogleReplicaPoolInstancesDescription()
      def errors = Mock(Errors)
    ...
    then:
      ...
      1 * errors.rejectValue("instanceIds", "recreateGoogleReplicaPoolInstancesDescription.instanceIds.empty")
  }
}
