...
class RegisterInstancesWithGoogleNetworkLoadBalancerDescriptionValidatorSpec extends Specification {
  ...
  @Shared
  RegisterInstancesWithGoogleNetworkLoadBalancerDescriptionValidator validator

  void setupSpec() {
    validator = new RegisterInstancesWithGoogleNetworkLoadBalancerDescriptionValidator()
  ...
  void "null input fails validation"() {
    ...
    then:
      ...
      1 * errors.rejectValue(
        'credentials', 'registerInstancesWithGoogleNetworkLoadBalancerDescription.credentials.empty')
      1 * errors.rejectValue(
        'networkLoadBalancerNames',
        'registerInstancesWithGoogleNetworkLoadBalancerDescription.networkLoadBalancerNames.empty')
      1 * errors.rejectValue(
        'region', 'registerInstancesWithGoogleNetworkLoadBalancerDescription.region.empty')
      1 * errors.rejectValue('' +
        'instanceIds', 'registerInstancesWithGoogleNetworkLoadBalancerDescription.instanceIds.empty')
  }
}
