...
class DeregisterInstancesFromLoadBalancerDescriptionValidatorSpec
    extends AbstractConfiguredRegionAndInstanceIdsValidatorSpec {
  @Override
  DescriptionValidator getDescriptionValidator() {
    return new DeregisterInstancesFromLoadBalancerDescriptionValidator()
  }

  @Override
  AbstractAmazonCredentialsDescription getDescription() {
    return new InstanceLoadBalancerRegistrationDescription()
  }
}
