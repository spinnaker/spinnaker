...
public class MetricStoresCommand extends AbstractConfigCommand {
  ...
  @Getter(AccessLevel.PUBLIC)
  private String description = "Configure Spinnaker's metric stores. This configuration only affects the publishing of metrics "
      + "against whichever metric stores you enable (it can be more than one).";
