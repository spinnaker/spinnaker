...
public class DeleteSearchCommandBuilder implements CommandBuilder {
  ...
  public NestableCommand build() {
    return new DeleteSearchCommand(repositoryName);
  }

  @Parameters(separators = "=")
  private static class DeleteSearchCommand extends AbstractDeleteSearchCommand {
    private DeleteSearchCommand(String repositoryName) {
