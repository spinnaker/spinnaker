...
public class DeleteArtifactAccountCommandBuilder implements CommandBuilder {
  ...
  public NestableCommand build() {
    return new DeleteArtifactAccountCommand(artifactProviderName);
  }

  @Parameters(separators = "=")
  private static class DeleteArtifactAccountCommand extends AbstractDeleteArtifactAccountCommand {
    private DeleteArtifactAccountCommand(String artifactProviderName) {
