...
public class GooglePubsubCommandProperties {
  public static final String TEMPLATE_PATH_DESCRIPTION = "A path to a jinja template that specifies how artifacts from this pubsub system are interpreted and transformed into Spinnaker artifacts. See spinnaker.io/reference/artifacts for more information.";
  ...
  public static final String TOPIC_NAME_DESCRIPTION = "The name of the topic to publish to. This identifier does not include the name of the project, and must already be configured for Spinnaker to work.";
