...
public class EditLdapRoleProviderCommand extends AbstractEditRoleProviderCommand<LdapRoleProvider> {
  ...
  @Parameter(
      names = "--manager-dn",
      description = "The manager user's distinguished name (principal) to use for querying ldap groups."
  )
  ...
  @Parameter(
      ...
      description = "The filter which is used to search for group membership. The default is "
  ...
  @Parameter(
      ...
      description = "The attribute which contains the name of the authority defined by the group "
  ...
  protected RoleProvider editRoleProvider(LdapRoleProvider ldap) {
    ...
    ldap.setGroupSearchFilter(isSet(groupSearchFilter) ? groupSearchFilter : ldap.getGroupSearchFilter());
    ldap.setGroupRoleAttributes(isSet(groupRoleAttributes) ? groupRoleAttributes : ldap.getGroupRoleAttributes());
