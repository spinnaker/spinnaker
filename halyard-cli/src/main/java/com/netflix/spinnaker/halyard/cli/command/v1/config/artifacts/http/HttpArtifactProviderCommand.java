...
public class HttpArtifactProviderCommand extends AbstractNamedArtifactProviderCommand {
  @Override
  protected String getArtifactProviderName() {
    return "http";
  }

  public HttpArtifactProviderCommand() {
    registerSubcommand(new HttpArtifactAccountCommand());
  }
}
