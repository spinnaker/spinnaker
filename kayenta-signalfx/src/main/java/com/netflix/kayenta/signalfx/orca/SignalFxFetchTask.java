...
public class SignalFxFetchTask implements RetryableTask {
  ...
  // Seems to be the pattern in the code base to have this code duplicated, I assume to prevent
  // independent implementations from being tightly coupled,
  @Nonnull
  @Override
    ...
    try {
      canaryScope =
          kayentaObjectMapper.readValue(
              (String) stage.getContext().get("canaryScope"), SignalFxCanaryScope.class);
    } catch (IOException e) {
