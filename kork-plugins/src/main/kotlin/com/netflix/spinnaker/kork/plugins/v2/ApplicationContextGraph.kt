...
internal object ApplicationContextGraph {
  lateinit var serviceApplicationContext: ApplicationContext
  val pluginContexts: MutableMap<String, ApplicationContext> = mutableMapOf()

  fun pluginContext(pluginId: String): ApplicationContext? =
