...
To build from source and run on localhost follow the https://www.spinnaker.io/setup/install/#getting-started[Getting Started Documentation].
...
brew install redis cassandra@2.1 packer
