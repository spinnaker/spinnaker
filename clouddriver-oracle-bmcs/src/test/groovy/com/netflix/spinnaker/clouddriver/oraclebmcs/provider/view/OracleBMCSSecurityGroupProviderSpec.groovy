...
class OracleBMCSSecurityGroupProviderSpec extends Specification {
  ...
  def "get all"() {
    ...
    def securityGroupProvider = new OracleBMCSSecurityGroupProvider(cache, new ObjectMapper())
    ...
    results.first().cloudProvider == OracleBMCSCloudProvider.ID
