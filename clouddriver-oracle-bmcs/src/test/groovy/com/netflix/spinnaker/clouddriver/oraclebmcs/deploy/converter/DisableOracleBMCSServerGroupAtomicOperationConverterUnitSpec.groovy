...
class DisableOracleBMCSServerGroupAtomicOperationConverterUnitSpec extends Specification {
  ...
  @Shared
  DisableOracleBMCSServerGroupAtomicOperationConverter converter

  def setupSpec() {
    this.converter = new DisableOracleBMCSServerGroupAtomicOperationConverter(objectMapper: mapper)
  ...
  void "disableOracleBMCSServerGroupDescription type returns EnableDisableOracleBMCSServerGroupDescription and DisableOracleBMCSServerGroupAtomicOperation"() {
    setup:
    ...
    then:
    operation instanceof DisableOracleBMCSServerGroupAtomicOperation
  }
}
