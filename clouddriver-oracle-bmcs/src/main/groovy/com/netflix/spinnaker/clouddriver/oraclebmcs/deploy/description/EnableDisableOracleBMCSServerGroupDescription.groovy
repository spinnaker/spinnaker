 ...
 */
class EnableDisableOracleBMCSServerGroupDescription extends AbstractOracleBMCSCredentialsDescription implements ServerGroupNameable, EnableDisableDescriptionTrait {
