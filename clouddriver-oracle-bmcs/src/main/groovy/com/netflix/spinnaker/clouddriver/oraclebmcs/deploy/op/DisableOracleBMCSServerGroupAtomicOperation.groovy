...
class DisableOracleBMCSServerGroupAtomicOperation extends AbstractEnableDisableAtomicOperation {

  final String phaseName = "DISABLE_SERVER_GROUP"

  DisableOracleBMCSServerGroupAtomicOperation(EnableDisableOracleBMCSServerGroupDescription description) {
    super(description)
  }
