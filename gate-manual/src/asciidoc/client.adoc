...
dependencies {
  compile "com.netflix.spinnaker.client:spinnaker-client:0.9"
}
```
...
buildscript {
  ...
  dependencies {
    classpath 'com.netflix.spinnaker.client:spinnaker-client:0.9'
  }
}
```
...
@Grab('com.netflix.spinnaker.client:spinnaker-client:0.9')
