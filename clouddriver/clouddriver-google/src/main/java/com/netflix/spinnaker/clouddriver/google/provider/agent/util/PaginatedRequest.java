...
public abstract class PaginatedRequest<T> {
  ...
  public void queue(
      ...
      throws IOException {
    PaginatedCallback<T> paginatedCallback =
        new PaginatedCallback<T>(callback) {
          @Override
  ...
  public <U> List<U> timeExecute(Function<T, List<U>> itemExtractor, String api, String... tags)
      throws IOException {
