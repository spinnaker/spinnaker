...
public class GoogleRegionalExternalHttpLoadBalancerCachingAgent
  ...
  private static final Logger log =
      LoggerFactory.getLogger(GoogleRegionalExternalHttpLoadBalancer.class);
  ...
  public List<GoogleLoadBalancer> constructLoadBalancers(String onDemandLoadBalancerName) {
    List<GoogleRegionalExternalHttpLoadBalancer> loadBalancers = new ArrayList<>();
      ...
      if (onDemandLoadBalancerName != null) {
        ...
        new PaginatedRequest<ForwardingRuleList>(this) {
          ...
          public String getNextPageToken(ForwardingRuleList forwardingRuleList) {
            ...
            frlCallback,
            "RegionalExternalHttpLoadBalancerCaching.forwardingRules");
      }

      executeIfRequestsAreQueued(
          forwardingRulesRequest, "RegionalExternalHttpLoadBalancerCaching.forwardingRules");
      executeIfRequestsAreQueued(
          targetProxyRequest, "RegionalExternalHttpLoadBalancerCaching.targetProxy");
      executeIfRequestsAreQueued(
          urlMapRequest, "RegionalExternalHttpLoadBalancerCaching.urlMapRequest");
      executeIfRequestsAreQueued(
          groupHealthRequest, "RegionalExternalHttpLoadBalancerCaching.groupHealth");
  ...
  public class ForwardingRuleCallbacks {
    ...
    public void cacheRemainderOfLoadBalancerResourceGraph(final ForwardingRule forwardingRule) {
      GoogleRegionalExternalHttpLoadBalancer newLoadBalancer =
          new GoogleRegionalExternalHttpLoadBalancer();
    ...
    public List<GoogleRegionalExternalHttpLoadBalancer> getLoadBalancers() {
      return loadBalancers;
    }

    public void setLoadBalancers(List<GoogleRegionalExternalHttpLoadBalancer> loadBalancers) {
      this.loadBalancers = loadBalancers;
    }

    private List<GoogleRegionalExternalHttpLoadBalancer> loadBalancers;
    ...
    public ForwardingRuleCallbacks(
        List<GoogleRegionalExternalHttpLoadBalancer> loadBalancers,
            ...
            .filter(
                f ->
                    f.getLoadBalancingScheme() != null
                        && f.getLoadBalancingScheme().equals("EXTERNAL"))
            .forEach(
                forwardingRule -> {
                  GoogleTargetProxyType type =
                      forwardingRule.getTarget() != null
  ...
  public class TargetHttpsProxyCallback extends BaseCallback<TargetHttpsProxy> {
    ...
    private GoogleRegionalExternalHttpLoadBalancer googleLoadBalancer;
    private GoogleBatchRequest urlMapRequest;
    private GoogleBatchRequest groupHealthRequest;
    private List<BackendService> projectBackendServices;
    private List<HealthCheck> projectHealthChecks;
    ...
    public TargetHttpsProxyCallback(
        GoogleRegionalExternalHttpLoadBalancer googleLoadBalancer,
        GoogleBatchRequest urlMapRequest,
        GoogleBatchRequest groupHealthRequest,
        List<BackendService> projectBackendServices,
        List<HealthCheck> projectHealthChecks,
  ...
  private void handleBackendService(
      ...
      GoogleRegionalExternalHttpLoadBalancer googleHttpLoadBalancer,
    ...
    List<GoogleBackendService> backendServicesInMap =
        Utils.getBackendServicesFromRegionalExternalHttpLoadBalancerView(
            googleHttpLoadBalancer.getView());
