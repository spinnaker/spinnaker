...
class UpsertGoogleServerGroupTagsAtomicOperationConverter extends AbstractAtomicOperationsCredentialsConverter<GoogleNamedAccountCredentials>{

  @Override
  AtomicOperation convertOperation(Map input) {
    new UpsertGoogleServerGroupTagsAtomicOperation(convertDescription(input))
  }
