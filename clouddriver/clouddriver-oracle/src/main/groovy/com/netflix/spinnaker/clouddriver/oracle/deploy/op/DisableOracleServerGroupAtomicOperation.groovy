...
class DisableOracleServerGroupAtomicOperation extends AbstractEnableDisableAtomicOperation {

  final String phaseName = "DISABLE_SERVER_GROUP"

  DisableOracleServerGroupAtomicOperation(EnableDisableOracleServerGroupDescription description) {
    super(description)
  }
