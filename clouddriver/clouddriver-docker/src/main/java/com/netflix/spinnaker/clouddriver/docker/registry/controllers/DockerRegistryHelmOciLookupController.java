...
public class DockerRegistryHelmOciLookupController extends AbstractDockerRegistryLookupController {
  ...
  protected String getTaggedImageNamespace() {
    return Keys.Namespace.TAGGED_HELM_OCI_IMAGE.getNs();
  }
}
