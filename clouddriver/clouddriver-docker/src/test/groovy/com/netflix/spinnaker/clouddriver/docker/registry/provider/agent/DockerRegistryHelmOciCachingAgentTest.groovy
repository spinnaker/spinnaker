...
class DockerRegistryHelmOciCachingAgentTest extends Specification {

  def KEY_PREFIX = "dockerRegistry"
  def ACCOUNT_NAME = "test-docker"
  def REGISTRY_NAME = "test-registry"
  def CACHE_GROUP_TAGGED_IMAGE = Keys.Namespace.TAGGED_HELM_OCI_IMAGE.ns
  def CACHE_GROUP_IMAGE_ID = Keys.Namespace.IMAGE_ID.ns

  DockerRegistryHelmOciCachingAgent agent
  ...
  def setup() {
    ...
    agent = new DockerRegistryHelmOciCachingAgent(provider, ACCOUNT_NAME, credentials, 0, 1, 1, REGISTRY_NAME)
  }
