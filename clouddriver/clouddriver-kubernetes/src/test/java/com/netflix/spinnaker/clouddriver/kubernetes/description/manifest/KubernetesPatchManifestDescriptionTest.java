...
/** See spinnaker/spinnaker#5992: {@code getPointCoordinates()} must resolve a blank namespace. */
final class KubernetesPatchManifestDescriptionTest {
  @Test
  void getPointCoordinatesDefaultsBlankNamespaceForNamespacedKind() {
    KubernetesPatchManifestDescription description = new KubernetesPatchManifestDescription();
