...
public class UpsertScalingPolicyAtomicOperationConverter
  ...
  public UpsertScalingPolicyDescription convertDescription(Map input) {
    UpsertScalingPolicyDescription converted =
        getObjectMapper().convertValue(input, UpsertScalingPolicyDescription.class);
