...
class UpsertWarmPoolAtomicOperationTest {
  ...
  @Test
  void shouldUpsertWarmPoolForEachAsg() {
    ...
    description.setMinSize(2);
    description.setMaxGroupPreparedCapacity(10);
    ...
    verify(mockAsgService, times(2)).putWarmPool("asg1", 2, 10, "Stopped", true);
    verifyNoMoreInteractions(mockAsgService);
  }

  @Test
  void shouldNotUpsertWarmPoolWhenAsgNotFound() {
    UpsertWarmPoolDescription description = new UpsertWarmPoolDescription();
    AsgDescription asg1 = new AsgDescription();
    asg1.setServerGroupName("asg1");
    asg1.setRegion("us-west-1");
