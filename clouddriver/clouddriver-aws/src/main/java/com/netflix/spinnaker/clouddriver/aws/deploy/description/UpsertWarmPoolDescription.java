...
@Data
public class UpsertWarmPoolDescription extends AbstractAmazonCredentialsDescription
    implements ServerGroupsNameable {

  private List<AsgDescription> asgs = new ArrayList<>();
  ...
  public Collection<String> getServerGroupNames() {
    return asgs.stream().map(AsgDescription::getServerGroupName).collect(Collectors.toList());
  }
}
