...
@Component("rebootAzureInstancesDescriptionValidator")
class RebootAzureInstancesDescriptionValidator extends DescriptionValidator<AzureInstanceDescription> {
  @Autowired
