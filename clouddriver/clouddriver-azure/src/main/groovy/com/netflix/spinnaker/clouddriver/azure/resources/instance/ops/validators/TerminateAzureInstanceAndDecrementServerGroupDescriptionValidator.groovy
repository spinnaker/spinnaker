...
@Component("terminateAzureInstanceAndDecrementServerGroupDescriptionValidator")
class TerminateAzureInstanceAndDecrementServerGroupDescriptionValidator
  extends DescriptionValidator<AzureInstanceDescription> {
  @Autowired
