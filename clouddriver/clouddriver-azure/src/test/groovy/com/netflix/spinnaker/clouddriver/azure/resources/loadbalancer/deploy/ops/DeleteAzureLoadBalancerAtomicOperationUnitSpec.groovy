...
import com.netflix.spinnaker.clouddriver.azure.resources.loadbalancer.ops.converters.DeleteAzureLoadBalancerAtomicOperationConverter
import com.netflix.spinnaker.clouddriver.data.task.Task
import com.netflix.spinnaker.clouddriver.data.task.TaskRepository
import spock.lang.Shared
import spock.lang.Specification

class DeleteAzureLoadBalancerAtomicOperationUnitSpec extends Specification {
  ...
  @Shared
  DeleteAzureLoadBalancerAtomicOperationConverter converter

  def setupSpec() {
    TaskRepository.threadLocalTask.set(Mock(Task))

    this.converter = new DeleteAzureLoadBalancerAtomicOperationConverter(objectMapper: mapper)
  ...
  void "should fail to delete a Network Load Balancer that does not exist"() {
    setup:
      ...
      //def operation = new DeleteAzureLoadBalancerAtomicOperation(description)

    when:
      def operation = converter.convertOperation(input)

    then:
      operation instanceof DeleteAzureLoadBalancerAtomicOperation
  }
}
