...
public interface Front50Service {
  ...
  @GET("v2/applications")
  Call<List<Map<String, Object>>> searchByName(
      @Query("name") String applicationName,
  ...
  @GET("v2/projects")
  Call<List<Map<String, Object>>> searchForProjects(
      @QueryMap Map<String, String> params, @Query("pageSize") Integer pageSize);
