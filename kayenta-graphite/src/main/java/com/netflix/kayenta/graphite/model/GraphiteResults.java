...
public class GraphiteResults {
  ...
  /**
   * graphite returns datapoints as a list of tuples of value and timestamp, Like: [[1, 12312312],
   * [0, 12312322], ...] we need to convert them to a list of values
   *
  ...
  /**
   * graphite's json render api will not explicitly show interval of datapoints. as it returns a
   * list a tuple of (value, timestamp), we need to get the diff of first two endpoints
   *
