...
public class DeleteSubscriptionCommandBuilder implements CommandBuilder {
  ...
  public NestableCommand build() {
    return new DeleteSubscriptionCommand(pubsubName);
  }

  @Parameters(separators = "=")
  private static class DeleteSubscriptionCommand extends AbstractDeleteSubscriptionCommand {
    private DeleteSubscriptionCommand(String pubsubName) {
