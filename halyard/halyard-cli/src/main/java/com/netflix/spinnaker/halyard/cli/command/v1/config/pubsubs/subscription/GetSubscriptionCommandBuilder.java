...
public class GetSubscriptionCommandBuilder implements CommandBuilder {
  ...
  public NestableCommand build() {
    return new GetSubscriptionCommand(pubsubName);
  }

  @Parameters(separators = "=")
  private static class GetSubscriptionCommand extends AbstractGetSubscriptionCommand {
    private GetSubscriptionCommand(String pubsubName) {
