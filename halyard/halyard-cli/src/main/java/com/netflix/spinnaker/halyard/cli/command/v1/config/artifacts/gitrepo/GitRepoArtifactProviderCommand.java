...
public class GitRepoArtifactProviderCommand extends AbstractNamedArtifactProviderCommand {
  @Override
  protected String getArtifactProviderName() {
    return "gitrepo";
  }

  public GitRepoArtifactProviderCommand() {
    registerSubcommand(new GitRepoArtifactAccountCommand());
  }
}
