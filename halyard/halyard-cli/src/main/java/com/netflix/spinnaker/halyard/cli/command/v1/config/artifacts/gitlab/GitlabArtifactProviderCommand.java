...
public class GitlabArtifactProviderCommand extends AbstractNamedArtifactProviderCommand {
  @Override
  protected String getArtifactProviderName() {
    return "gitlab";
  }

  public GitlabArtifactProviderCommand() {
    registerSubcommand(new GitlabArtifactAccountCommand());
  }
}
