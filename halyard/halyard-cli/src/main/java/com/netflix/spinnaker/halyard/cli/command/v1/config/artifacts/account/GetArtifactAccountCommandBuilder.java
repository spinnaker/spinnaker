...
public class GetArtifactAccountCommandBuilder implements CommandBuilder {
  @Setter String artifactProviderName;

  @Override
  public NestableCommand build() {
    return new GetArtifactAccountCommand(artifactProviderName);
  }

  @Parameters(separators = "=")
  private static class GetArtifactAccountCommand extends AbstractGetArtifactAccountCommand {
    private GetArtifactAccountCommand(String artifactProviderName) {
