...
public class PubsubEnableDisableCommandBuilder implements CommandBuilder {
  ...
  public NestableCommand build() {
    return new PubsubEnableDisableCommand(pubsubName, enable);
  }

  @Parameters(separators = "=")
  private static class PubsubEnableDisableCommand extends AbstractPubsubEnableDisableCommand {
    private PubsubEnableDisableCommand(String pubsubName, boolean enable) {
