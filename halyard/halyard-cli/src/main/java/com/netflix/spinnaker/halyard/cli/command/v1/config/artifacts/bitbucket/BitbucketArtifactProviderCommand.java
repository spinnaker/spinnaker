...
public class BitbucketArtifactProviderCommand extends AbstractNamedArtifactProviderCommand {
  @Override
  protected String getArtifactProviderName() {
    return "bitbucket";
  }

  public BitbucketArtifactProviderCommand() {
    registerSubcommand(new BitbucketArtifactAccountCommand());
  }
}
