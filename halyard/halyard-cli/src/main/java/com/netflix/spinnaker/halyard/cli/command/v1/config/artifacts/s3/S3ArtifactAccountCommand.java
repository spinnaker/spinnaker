...
public class S3ArtifactAccountCommand extends AbstractArtifactAccountCommand {
  @Override
  protected String getArtifactProviderName() {
    return "s3";
  }

  public S3ArtifactAccountCommand() {
    registerSubcommand(new S3AddArtifactAccountCommand());
    registerSubcommand(new S3EditArtifactAccountCommand());
  }
}
