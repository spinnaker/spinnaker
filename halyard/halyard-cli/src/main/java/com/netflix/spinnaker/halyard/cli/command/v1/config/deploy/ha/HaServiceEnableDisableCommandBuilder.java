...
public class HaServiceEnableDisableCommandBuilder implements CommandBuilder {
  ...
  private static class HaServiceEnableDisableCommand extends AbstractHaServiceEnableDisableCommand {
    private HaServiceEnableDisableCommand(String serviceName, boolean enable) {
