...
public class NotificationCommand extends AbstractConfigCommand {
  ...
  protected void executeThis() {
    ...
    new OperationHandler<Notifications>()
        .setOperation(Daemon.getNotifications(currentDeployment, !noValidate))
        .setFormat(AnsiFormatUtils.Format.STRING)
        .setUserFormatted(true)
        .setSuccessMessage("Configured notifications: ")
        .setFailureMesssage("Failed to load notifications.")
        .get();
  }
}
