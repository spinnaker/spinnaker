...
@Data
@Component
public abstract class EchoService extends SpringService<EchoService.Echo> {
  @Autowired EchoProfileFactory echoProfileFactory;
  ...
  public List<Profile> getProfiles(
    ...
    Profile profile =
        echoProfileFactory.getProfile(filename, path, deploymentConfiguration, endpoints);
