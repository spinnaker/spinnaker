...
/** A role (group) that a user belongs to. Role names are normalized to lower-case. */
public class Role {

  private String name;
  private int hashCode;

  /** The mechanism that asserted this role. */
  public enum Source {
    EXTERNAL,
    FILE,
    GOOGLE_GROUPS,
  ...
  public String toString() {
    return "Role(resourceType=" + getResourceType() + ", name=" + name + ", source=" + source + ")";
  }
}
