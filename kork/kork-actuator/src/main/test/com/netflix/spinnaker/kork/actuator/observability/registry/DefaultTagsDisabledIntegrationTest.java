...
public class DefaultTagsDisabledIntegrationTest {

  @Test
  public void test_default_tags_are_absent_when_disabled() {
    ApplicationContextRunner runner =
        new ApplicationContextRunner()
            ...
            .withPropertyValues(
                ...
                "observability.config.metrics.prometheus.registry.default-tags-disabled=true")
    ...
    runner.run(
        context -> {
          ...
          // when default tags disabled, we should not see spinSvc=my-service tag in output
          assertFalse(body.contains("spinSvc"));
        });
  }
}
