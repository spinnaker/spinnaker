...
package com.netflix.spinnaker.security.roles.ldap;

import com.netflix.spinnaker.security.roles.UserRolesProviderCacheConfig;
...
/** Configures the LDAP context source used for role resolution. */
@Configuration
...
public class LdapConfig {
  ...
  public static class ConfigProps {
    ...
    /**
     * The attribute used for parsing the id of the fetched ldap user. This is the id provided when
     * logging in the user, eg. employee email. This attribute is used for creating a map of the
     * user dn to user id.
     */
