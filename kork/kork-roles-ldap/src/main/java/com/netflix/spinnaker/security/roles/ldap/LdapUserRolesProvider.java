...
import com.netflix.spinnaker.security.roles.BaseUserRolesProvider;
...
/** Resolves user roles from LDAP group memberships. */
@Slf4j
@Component
      ...
      Iterables.partition(userIds, configProps.getLoadUserDNsBatchSize())
          .forEach(
              userIdsInBatch -> {
                ...
                // (|(employeeEmail=foo@mycompany.com)(employeeEmail=bar@mycompany.com)...)
