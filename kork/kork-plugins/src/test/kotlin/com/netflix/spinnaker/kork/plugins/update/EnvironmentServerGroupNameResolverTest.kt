...
class EnvironmentServerGroupNameResolverTest : JUnit5Minutests {
  ...
  fun tests() = rootContext<Fixture> {
    ...
    test("returns value of existing property") {
      every { environment.getProperty(eq("NETFLIX_AUTO_SCALE_GROUP")) } returns "orca-test-v000"
      expectThat(subject.get()).isEqualTo("orca-test-v000")
    }
  }
