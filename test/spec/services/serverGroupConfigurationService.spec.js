...
describe('Service: ServerGroupConfiguration', function () {

  beforeEach(loadDeckWithoutCacheInitializer);

  beforeEach(inject(function (_serverGroupConfigurationService_) {
    this.service = _serverGroupConfigurationService_;
  }));
