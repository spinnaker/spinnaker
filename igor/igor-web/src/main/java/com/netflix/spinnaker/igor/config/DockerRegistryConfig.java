...
@Configuration
@Conditional(DockerRegistryEnabledCondition.class)
@EnableConfigurationProperties({DockerRegistryProperties.class, HelmOciDockerRegistryProperties.class})
public class DockerRegistryConfig {
    ...
    @Bean
    public ClouddriverService dockerRegistryProxyService(
