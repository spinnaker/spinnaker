...
public class TestUtils {
  ...
  public static SpinnakerHttpException makeSpinnakerHttpException(
      String url, int code, ResponseBody body) {
  ...
  public static OkHttp3ClientConfiguration makeOkHttpClientConfig() {
