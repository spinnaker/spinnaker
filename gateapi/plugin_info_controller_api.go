...
func (a *PluginInfoControllerApiService) GetAllPluginInfoUsingGET(ctx context.Context, localVarOptionals map[string]interface{}) ([]Mapobjectobject,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  []Mapobjectobject
	)
