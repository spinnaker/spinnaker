 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return interface{}*/
func (a *SecurityGroupControllerApiService) AllByAccountUsingGET(ctx context.Context, account string, localVarOptionals map[string]interface{}) (interface{},  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xRateLimitApp" (string) X-RateLimit-App
 @return interface{}*/
func (a *SecurityGroupControllerApiService) AllUsingGET2(ctx context.Context, localVarOptionals map[string]interface{}) (interface{},  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "xRateLimitApp" (string) X-RateLimit-App
 @return interface{}*/
func (a *SecurityGroupControllerApiService) GetSecurityGroupUsingGET(ctx context.Context, account string, region string, name string, localVarOptionals map[string]interface{}) (interface{},  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
