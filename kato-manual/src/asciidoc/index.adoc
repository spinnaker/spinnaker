...
- - -
include::src/asciidoc/ops/createAmazonLoadBalancerDescription.adoc[]
- - -
...
- - -
include::src/asciidoc/ops/tagAsgDescription.adoc[]
- - -
...
See https://raw.githubusercontent.com/bluespar/kato/master/LICENSE.txt[LICENSE.txt] for more information.