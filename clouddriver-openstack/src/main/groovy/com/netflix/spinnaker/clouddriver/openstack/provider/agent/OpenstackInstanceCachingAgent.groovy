...
class OpenstackInstanceCachingAgent extends AbstractOpenstackCachingAgent {
  ...
  static final Set<AgentDataType> types = Collections.unmodifiableSet([
    AUTHORITATIVE.forType(Namespace.INSTANCES.ns)
  ] as Set)
  ...
  CacheResult loadData(ProviderCache providerCache) {
    ...
    List<Server> servers = clientProvider.getInstances(region)
    ...
    new DefaultCacheResult([(Namespace.INSTANCES.ns): cachedInstances.values()])
  }
}
