...
@Component("deployOpenstackDescription")
class DeployOpenstackAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  @Override
  AtomicOperation convertOperation(Map input) {
    new DeployOpenstackAtomicOperation(convertDescription(input))
  }

  @Override
  DeployOpenstackAtomicOperationDescription convertDescription(Map input) {
    OpenstackAtomicOperationConverterHelper.convertDescription(input, this, DeployOpenstackAtomicOperationDescription)
  }
}
