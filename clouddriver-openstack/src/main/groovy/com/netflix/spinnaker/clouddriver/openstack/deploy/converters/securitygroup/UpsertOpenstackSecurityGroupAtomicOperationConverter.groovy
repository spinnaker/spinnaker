...
class UpsertOpenstackSecurityGroupAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  ...
  @Override
  OpenstackSecurityGroupDescription convertDescription(Map input) {
    OpenstackAtomicOperationConverterHelper.convertDescription(input, this, OpenstackSecurityGroupDescription)
  }
}
