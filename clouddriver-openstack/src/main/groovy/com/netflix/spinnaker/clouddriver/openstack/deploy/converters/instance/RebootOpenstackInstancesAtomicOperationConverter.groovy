...
import com.netflix.spinnaker.clouddriver.openstack.deploy.ops.instance.RebootOpenstackInstancesAtomicOperation
...
@Component("rebootOpenstackInstancesDescription")
class RebootOpenstackInstancesAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  @Override
  AtomicOperation convertOperation(Map input) {
    new RebootOpenstackInstancesAtomicOperation(convertDescription(input))
  }
