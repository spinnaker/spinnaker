...
/**
 * curl -X POST -H "Content-Type: application/json" -d '[ { "enableInstancesInDiscovery": { "instanceIds": ["155e68a7-a7dd-433a-b2c1-c8d6d38fb89a"], "region": "RegionOne", "account": "my-openstack-account" }} ]' localhost:7002/openstack/ops
 */
class EnableInstancesInDiscoveryOperation extends AbstractEnableDisableInstancesInDiscoveryOperation {
  ...
  EnableInstancesInDiscoveryOperation(OpenstackInstancesDescription description) {
    super(description)
  }
}
