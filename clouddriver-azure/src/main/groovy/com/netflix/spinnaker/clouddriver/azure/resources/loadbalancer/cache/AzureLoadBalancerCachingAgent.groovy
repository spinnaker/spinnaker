...
@Slf4j
class AzureLoadBalancerCachingAgent implements CachingAgent, AccountAware {
  ...
  CacheResult loadData(ProviderCache providerCache) {
    ...
    def loadBalancers = creds.networkClient.getLoadBalancersAll(creds, region)

    List<CacheData> data = loadBalancers.collect() { AzureLoadBalancerDescription loadBalancer ->
      Map<String, Object> attributes = [loadbalancer: loadBalancer]
      new DefaultCacheData(Keys.getLoadBalancerKey(azureCloudProvider,
