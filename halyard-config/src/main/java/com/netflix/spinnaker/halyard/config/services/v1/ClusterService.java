...
public class ClusterService {
  ...
  public void setCluster(String deploymentName, String providerName, String clusterName, Cluster newCluster) {
    final HasClustersProvider clustersProvider = providerService
        .getHasClustersProvider(deploymentName, providerName);
