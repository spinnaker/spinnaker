...
class CloudFoundryDeployDescriptionValidatorSpec extends Specification {
  ...
  void setupSpec() {
    ...
    validator = new CloudFoundryDeployDescriptionValidator(accountCredentialsProvider: credentialsProvider)
  }
  ...
  void "null input fails validation"() {
    ...
    then:
    1 * errors.rejectValue('cloudFoundryDeployDescription.credentials.api', _)
    1 * errors.rejectValue('cloudFoundryDeployDescription.credentials.org', _)
    1 * errors.rejectValue('cloudFoundryDeployDescription.credentials.space', _)
    1 * errors.rejectValue('cloudFoundryDeployDescription.application', _)
    1 * errors.rejectValue('cloudFoundryDeployDescription.repository', _)
    1 * errors.rejectValue('cloudFoundryDeployDescription.artifact', _)
  }
  ...
  void "invalid targetSize fails validation"() {
    ...
    then:
    1 * errors.rejectValue('cloudFoundryDeployDescription.targetSize', _)
