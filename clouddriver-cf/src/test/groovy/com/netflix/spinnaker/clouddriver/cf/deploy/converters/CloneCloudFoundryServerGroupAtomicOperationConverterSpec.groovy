...
/**
 * Test cases for {@link CloneCloudFoundryServerGroupAtomicOperationConverter}
 *
 *
 */
class CloneCloudFoundryServerGroupAtomicOperationConverterSpec extends Specification {
  ...
  def setupSpec() {
    ...
    this.converter = new CloneCloudFoundryServerGroupAtomicOperationConverter(objectMapper: mapper,
        accountCredentialsProvider: accountCredentialsProvider,
        repository: credentialsRepo
    )
  }

  def "should return CloudFoundryDeployDescription and CloneCloudFoundryServerGroupAtomicOperation"() {
    setup:
    ...
    then:
    operation instanceof CloneCloudFoundryServerGroupAtomicOperation
  }
