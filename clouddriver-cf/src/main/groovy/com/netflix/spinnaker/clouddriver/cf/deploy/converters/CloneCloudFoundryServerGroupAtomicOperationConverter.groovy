...
class CloneCloudFoundryServerGroupAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
	...
	AtomicOperation convertOperation(Map input) {
		def op = new CloneCloudFoundryServerGroupAtomicOperation(convertDescription(input))
		op.deployHandler = deployHandler
		op
	}
	...
	Object convertDescription(Map input) {
		...
		converted.space = converted.credentials.space
