...
/**
 * curl -X POST -H "Content-Type: application/json" -d '[ { "enableInstancesInDiscovery": { "instanceIds": ["myapp-dev-v000-asdfax"], "region": "us-central1", "credentials": "my-account-name" }} ]' localhost:7002/gce/ops
 */
class EnableInstancesInDiscoveryOperation extends AbstractEnableDisableInstancesInDiscoveryOperation {
  EnableInstancesInDiscoveryOperation(GoogleInstanceListDescription description) {
    super(description)
  }
