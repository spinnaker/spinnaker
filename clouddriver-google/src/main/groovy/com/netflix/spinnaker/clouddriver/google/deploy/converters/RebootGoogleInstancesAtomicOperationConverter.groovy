...
class RebootGoogleInstancesAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  ...
  @Override
  RebootGoogleInstancesDescription convertDescription(Map input) {
    GoogleAtomicOperationConverterHelper.convertDescription(input, this, RebootGoogleInstancesDescription)
  }
}
