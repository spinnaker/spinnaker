...
class AbandonAndDecrementGoogleServerGroupAtomicOperationConverter
  ...
  AtomicOperation convertOperation(Map input) {
    new AbandonAndDecrementGoogleServerGroupAtomicOperation(convertDescription(input))
  }

  @Override
  AbandonAndDecrementGoogleServerGroupDescription convertDescription(Map input) {
    GoogleAtomicOperationConverterHelper.convertDescription(
        input, this, AbandonAndDecrementGoogleServerGroupDescription)
  }
}
