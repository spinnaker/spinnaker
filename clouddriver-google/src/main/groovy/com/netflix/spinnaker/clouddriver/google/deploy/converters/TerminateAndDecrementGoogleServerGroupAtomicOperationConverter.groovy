...
import com.netflix.spinnaker.clouddriver.google.deploy.ops.TerminateAndDecrementGoogleServerGroupAtomicOperation
...
class TerminateAndDecrementGoogleServerGroupAtomicOperationConverter
  ...
  AtomicOperation convertOperation(Map input) {
    new TerminateAndDecrementGoogleServerGroupAtomicOperation(convertDescription(input))
  }

  @Override
  TerminateAndDecrementGoogleServerGroupDescription convertDescription(Map input) {
    GoogleAtomicOperationConverterHelper.convertDescription(
        input, this, TerminateAndDecrementGoogleServerGroupDescription)
  }
}
