...
import Canary, { canaryStore } from '../canary';
...
import SelectConfig from '../edit/selectConfig';
import ResultDetailLoader from '../report/detail/detailLoader';
import ExecutionListLoadStates from '../report/list/loadStates';
import Report from '../report/report';

export function registerStates(_router: UIRouter, applicationStateProvider: ApplicationStateProvider) {
