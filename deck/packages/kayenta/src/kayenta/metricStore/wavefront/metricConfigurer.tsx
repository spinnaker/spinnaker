...
/**
 * Wavefront is Template-only: it gained customInlineTemplate/customFilterTemplate support as part
 ...
 * worth it. This just renders the shared template editor directly, with Wavefront's own available
 * variables hint.
 */
