...
/**
 * InfluxDB is Template-only: it gained query.template support as part of the same change that
 ...
 * shared template editor directly, with InfluxDB's own available variables hint.
 */
