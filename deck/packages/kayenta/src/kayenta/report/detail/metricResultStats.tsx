...
import type { ICanaryAnalysisResultsStats } from '../../domain';
...
import type { IMetricSetPair } from '../../domain/IMetricSetPair';
import FormattedDate from '../../layout/formattedDate';
import type { ITableColumn } from '../../layout/table';
import { NativeTable } from '../../layout/table';
import type { ICanaryState } from '../../reducers';
import { runSelector, selectedMetricConfigSelector } from '../../selectors';
