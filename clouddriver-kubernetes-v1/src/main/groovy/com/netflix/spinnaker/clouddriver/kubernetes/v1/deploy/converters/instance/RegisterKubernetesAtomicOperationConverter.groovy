...
import com.netflix.spinnaker.clouddriver.kubernetes.v1.deploy.ops.instance.RegisterKubernetesAtomicOperation
import com.netflix.spinnaker.clouddriver.orchestration.AtomicOperation
import com.netflix.spinnaker.clouddriver.orchestration.AtomicOperations
import com.netflix.spinnaker.clouddriver.security.AbstractAtomicOperationsCredentialsSupport
import org.springframework.stereotype.Component

@KubernetesOperation(AtomicOperations.REGISTER_INSTANCES_WITH_LOAD_BALANCER)
@Component
class RegisterKubernetesAtomicOperationConverter extends AbstractAtomicOperationsCredentialsSupport {
  @Override
  AtomicOperation convertOperation(Map input) {
    new RegisterKubernetesAtomicOperation(convertDescription(input))
  }
