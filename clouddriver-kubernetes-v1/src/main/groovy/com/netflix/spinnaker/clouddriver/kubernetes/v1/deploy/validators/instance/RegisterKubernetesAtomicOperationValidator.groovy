...
@Component
class RegisterKubernetesAtomicOperationValidator extends DescriptionValidator<AbstractRegistrationKubernetesAtomicOperationDescription> {
  @Autowired
  ...
  void validate(List priorDescriptions, AbstractRegistrationKubernetesAtomicOperationDescription description, Errors errors) {
    def helper = new StandardKubernetesAttributeValidator("registerKubernetesAtomicOperationDescription", errors)
