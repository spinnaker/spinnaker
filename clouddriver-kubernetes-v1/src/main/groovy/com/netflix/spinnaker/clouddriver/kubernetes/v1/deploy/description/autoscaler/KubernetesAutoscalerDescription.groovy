...
package com.netflix.spinnaker.clouddriver.kubernetes.v1.deploy.description.autoscaler
...
class KubernetesAutoscalerDescription extends ResizeKubernetesAtomicOperationDescription {
  KubernetesScalingPolicy scalingPolicy

  KubernetesAutoscalerDescription() { }

  KubernetesAutoscalerDescription(String serverGroupName, DeployKubernetesAtomicOperationDescription description) {
    this.capacity = description.capacity
    this.scalingPolicy = description.scalingPolicy
