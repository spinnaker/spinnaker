...
class OperationsController {
  ...
  DeferredResult<Map<String, String>> ops(@RequestBody List<Map> input) {
    start([application: null, name: null, stages: input])
  }
  ...
  DeferredResult<Map<String, String>> ops(@RequestBody Map input) {
    start([application: input.application, name: input.description, stages: input.job])
  }
  ...
  private DeferredResult<Map<String, String>> start(Map config) {
