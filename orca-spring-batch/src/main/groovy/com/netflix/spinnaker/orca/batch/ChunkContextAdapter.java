...
public class ChunkContextAdapter implements TaskContext {
  ...
  ChunkContextAdapter(ChunkContext chunkContext) {
    ...
    inputs = new ImmutableMap.Builder<String, Object>()
      .putAll(entries)
      .build();
  }

  @Override public ImmutableMap<String, Object> getInputs() {
    return inputs;
  }
}
