...
export const updateMetricNanStrategy = createAction<{id: string, strategy: string}>(Actions.UPDATE_METRIC_NAN_STRATEGY);
export const updateMetricCriticality = createAction<{id: string, critical: boolean}>(Actions.UPDATE_METRIC_CRITICALITY);
...
export const loadMetricsServiceMetadataRequest = createAction<{filter: string, metricsAccountName: string}>(Actions.LOAD_METRICS_SERVICE_METADATA_REQUEST);
...
export const updatePrometheusMetricDescriptorFilter = createAction<{filter: string}>(Actions.UPDATE_PROMETHEUS_METRIC_DESCRIPTOR_FILTER);
