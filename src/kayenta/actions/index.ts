...
export const LOAD_RESULT_REQUEST = 'load_report_request';
export const LOAD_RESULT_SUCCESS = 'load_report_success';
export const LOAD_RESULT_FAILURE = 'load_report_failure';
export const SELECT_RESULT_METRIC_GROUP = 'select_result_metric_group';
export const SELECT_RESULT_METRIC = 'select_result_metric';
export const UPDATE_RESULT_SUMMARIES = 'update_result_summaries';
