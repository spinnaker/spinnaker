...
object AmazonSecurityGroupConverterTest {
  ...
  private val objectMapper = configureObjectMapper(
    ...
    KeelProperties(),
    listOf(
      ObjectMapperSubtypeConfigurer.ClassSubtypeLocator(AmazonSecurityGroupSpec::class.java, listOf("com.netflix.spinnaker.keel.asset")),
      ObjectMapperSubtypeConfigurer.ClassSubtypeLocator(SecurityGroupRule::class.java, listOf("com.netflix.spinnaker.keel.asset"))
    )
  )
