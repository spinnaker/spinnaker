...
class CompositeStorageContainerSqlToProgressTest {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(CompositeStorageContainerSqlToProgressTest.class);
  ...
  private static final PostgreSQLContainer postgres =
      new PostgreSQLContainer(DockerImageName.parse("postgres:15"))
          .withDatabaseName("front50migrated");
  ...
  private static String getSpringApplicationJson() throws JsonProcessingException {
    ...
    Map<String, String> properties =
        Map.ofEntries(
            ...
            Map.entry("sql.connectionPools.secondary.user", postgres.getUsername()),
            Map.entry("sql.connectionPools.secondary.password", postgres.getPassword()),
            Map.entry("sql.connectionPools.secondary.dialect", "POSTGRES"),
