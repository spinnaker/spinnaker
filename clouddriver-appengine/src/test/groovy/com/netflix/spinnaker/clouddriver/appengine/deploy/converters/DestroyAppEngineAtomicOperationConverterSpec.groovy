...
class DestroyAppEngineAtomicOperationConverterSpec extends Specification {
  ...
  void "destroyAppEngineDescription type returns DestroyAppEngineDescription and DestroyAppEngineAtomicOperation"() {
    ...
    then:
      description instanceof DestroyAppEngineDescription

    when:
      def operation = converter.convertOperation(input)

    then:
      operation instanceof DestroyAppEngineAtomicOperation
  }
}
