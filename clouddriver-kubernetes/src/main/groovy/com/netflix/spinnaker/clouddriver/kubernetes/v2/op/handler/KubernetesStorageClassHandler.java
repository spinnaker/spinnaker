...
import static com.netflix.spinnaker.clouddriver.kubernetes.v2.op.handler.KubernetesHandler.DeployPriority.STORAGE_CLASS_PRIORITY;

@Component
public class KubernetesStorageClassHandler extends KubernetesHandler {
  @Override
