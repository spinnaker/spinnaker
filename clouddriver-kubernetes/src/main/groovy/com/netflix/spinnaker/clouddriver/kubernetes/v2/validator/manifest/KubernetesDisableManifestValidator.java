...
@Component
public class KubernetesDisableManifestValidator extends DescriptionValidator<KubernetesEnableDisableManifestDescription> {
  @Autowired
  AccountCredentialsProvider provider;

  @Override
  public void validate(List priorDescriptions, KubernetesEnableDisableManifestDescription description, Errors errors) {
    KubernetesValidationUtil util = new KubernetesValidationUtil("disableKubernetesManifest", errors);
