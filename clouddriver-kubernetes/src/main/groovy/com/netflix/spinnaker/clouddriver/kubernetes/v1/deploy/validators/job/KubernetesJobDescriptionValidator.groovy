...
class KubernetesJobDescriptionValidator {
  static void validate(KubernetesJobDescription description, StandardKubernetesAttributeValidator helper, AccountCredentialsProvider accountCredentialsProvider) {
    if (!helper.validateCredentials(description.account, accountCredentialsProvider)) {
      return
    }

    helper.validateName(description.jobName, "jobName")
  }
}
